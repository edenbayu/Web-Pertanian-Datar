    ...
    <nav class="navbar padding">
            <div class="container height-navbar w-100">
                <div class="brand">
                    ...
                    <img src="assets/icons/Logo.svg" alt="agriask logo" class="mb-2" width="150px">
                    </a>
                </div>
                    ...
                    <div class="bg-transparent card border-0 my-auto">
                        <div class="card-body">
                            <div class="w-100 text-center">
                                <img src="assets/icons/Logo.svg" alt="agriask logo" class="mb-3" width="300px">
                            </div>

                            <h5 class="card-title fs-2 sign-in-tittle">Silahkan Login ke Akun Anda!</h5>
                            <p class="card-text text-secondary sign-in-desc">Tanya jawab seputar permasalahan Tanimu</p>
