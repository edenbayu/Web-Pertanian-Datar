...
<head>
    ...
    <meta name="author" content="kkndatar@gmail.com">
            ...
            <div class="container height-navbar w-100">
                <div class="brand">
                    <a href="/home" class="page-scroll">
                        <img src="assets/icons/Logo.svg" alt="tanidatar logo" class="mb-2" width="150px">
                    </a>
                </div>
    ...
    <footer class="footer-custom">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <h4 class="text-center mt-4 mb-3 footer-title fw-light">TaniDatar</h4>
                        <p class="text-center footer-desc fw-light">TaniDatar adalah website diskusi dan berbagi
                            informasi seputar pertanian terkini.</p>
                        <p class="text-center footer-email fw-light">Contact us: kkndatar2324@outlook.com</p>
                ...
                <div class="d-flex justify-content-between copyright-footer">
                    <div>
                        <p class="copyright-txt fw-light">Copyright &copy;2024</p>
                    </div>
